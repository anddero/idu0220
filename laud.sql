...
(
	...
	CONSTRAINT CHK_Isik_synni_kp_lubatud_vahemik CHECK (synni_kp >= '01.01.1900' AND synni_kp <= '12.31.2100'),
	CONSTRAINT CHK_Isik_synni_kp_v2iksem_v6rdne_isiku_registreerimise_ajast CHECK (synni_kp <= reg_aeg),
	CONSTRAINT CHK_Isik_reg_aeg_lubatud_vahemik CHECK (reg_aeg >= '01.01.2010' AND reg_aeg <= '12.31.2100'),
	...
	CONSTRAINT CHK_Isik_synni_kp_v2iksem_v6rdne_kui_hetke_kuupaev CHECK (synni_kp <= current_date),
	CONSTRAINT CHK_Isik_reg_aeg_v2iksem_v6rdne_kui_hetkeaeg CHECK (reg_aeg <= current_date),
...
(
	...
	CONSTRAINT CHK_Laud_reg_aeg_lubatud_vahemik CHECK (reg_aeg >= '01.01.2010' AND reg_aeg <= '12.31.2100'),
	...
	CONSTRAINT CHK_Laud_reg_aeg_v2iksem_v6rdne_hetkeajast CHECK (reg_aeg <= current_date),
