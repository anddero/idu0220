...
insert into isik (isiku_id, isikukoodi_riik, e_meil, isikukood, synni_kp, parool, eesnimi, perenimi, elukoht)values (7,'EST','nilsemil.lille2@gmail.com',3554152,'03.20.2018','parool','Nils','Nils','Rakvere');
insert into isik (isiku_id, isikukoodi_riik, e_meil, isikukood, synni_kp, parool, eesnimi, perenimi, elukoht)values (8,'DEU','kaspar2@gmail.com',5152152,'05.01.2018','parool','Kaspar','Nils','Tallinn');
insert into isik (isiku_id, isikukoodi_riik, e_meil, isikukood, synni_kp, parool, eesnimi, perenimi, elukoht)values (9,'RUS','merje2@mail.ee',5125126,'05.01.2018','parool','Nils','Pajula','Keila');
insert into isik (isiku_id, isikukoodi_riik, e_meil, isikukood, synni_kp, parool, eesnimi, perenimi, elukoht)values (10,'RUS','maxim2@max.ee',5512423,'04.01.2018','paroo','Maxim','Nils','Tallinn');
insert into isik (isiku_id, isikukoodi_riik, e_meil, isikukood, synni_kp, parool, eesnimi, perenimi, elukoht)values (11,'RUS','markus2@ttu.ee',565123,'05.01.2018','PASSWORD','Mihkel','Muhkel','Mägilinna');
...
insert into tootaja (isiku_id, amet_kood, mentor) values (7,1,3);
insert into tootaja (isiku_id, amet_kood, mentor) values (8,3,null );
insert into tootaja (isiku_id, amet_kood, mentor) values (9,4,null);
insert into tootaja (isiku_id, amet_kood, mentor) values (10,2,null );
insert into tootaja (isiku_id, amet_kood, mentor) values (11,2,null );

insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (1,1,'05.02.2018',1, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (2,1,'05.02.2018',1, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (3,1,'05.02.2018',1, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (4,1,'05.02.2018',2, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (5,1,'05.02.2018',3, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (6,1,'05.03.2018',4, 2,'Eriline,habras.');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (7,1,'05.03.2018',3, 2,'Ruumi on ka rohkemate jaoks');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (8,1,'05.02.2018',2, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (9,1,'05.02.2018',3, 2,'Laud nagu laud ikka');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (10,1,'05.03.2018',4, 2,'Eriline,habras.');
insert into laud (laua_kood, tootaja_id, reg_kp, laua_materjal_kood, kohtade_arv, kommentaar)values (11,1,'05.03.2018',3, 2,'Ruumi on ka rohkemate jaoks');
...
insert into klient (isiku_id, on_nous_tylitamisega, kliendi_seisundi_liik_kood) values (5,TRUE,1);
insert into klient (isiku_id, on_nous_tylitamisega, kliendi_seisundi_liik_kood) values (6,FALSE,1);
insert into klient (isiku_id, on_nous_tylitamisega, kliendi_seisundi_liik_kood) values (7,FALSE,1);
insert into klient (isiku_id, on_nous_tylitamisega, kliendi_seisundi_liik_kood) values (8,TRUE,1);
insert into klient (isiku_id, on_nous_tylitamisega, kliendi_seisundi_liik_kood) values (9,FALSE,1);
insert into klient (isiku_id, on_nous_tylitamisega, kliendi_seisundi_liik_kood) values (10,FALSE,1);
